...
const ASSESSMENT_HREF = "/brain-assessment";
...
const WHAT_YOU_GET = [
  ...
  {
    title: "No prescriptions, no obligation",
    detail: "Just objective data on how your brain is performing today.",
  },
] as const;
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        <Reveal className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted">
            Before anyone talks about a program, you get something concrete: a
            short, objective cognitive assessment scored against your age
            group. It costs nothing, it takes minutes, and it turns
            &ldquo;something feels off&rdquo; into data you can actually look
            at.
          </p>
        </Reveal>
          ...
          <Reveal offset={24} className="lg:col-span-6">
            <div className="overflow-hidden rounded-2xl border border-rule bg-ink shadow-[0_24px_60px_-30px_rgba(11,18,32,0.45)]">
              <video
                ...
                playsInline
                preload="none"
                poster="/videos/brain-assessment-offer-poster.jpg"
